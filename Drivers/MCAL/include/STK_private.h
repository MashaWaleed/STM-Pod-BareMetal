 ...
 */
    ...
    #define STK_AHB_CLK       MCAL_RCC_GetHCLK()   /**< Processor clock (AHB clock) divided by 1 */
#elif STK_CTRL_CLKSOURCE == STK_CTRL_CLKSOURCE_8
    #define STK_AHB_CLK       MCAL_RCC_GetHCLK()/8   /**< Processor clock (AHB clock) divided by 8 */
#else
